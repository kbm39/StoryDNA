...
**Version relationship:** Constitution v1.0 remains the ratified base document. Amendment 001 **supplements** v1.0 and does not replace it. Effective governance is **v1.0 + Amendment 001**.
