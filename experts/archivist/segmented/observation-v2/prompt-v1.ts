/**
 * Historical model-facing V2 extraction prompt @v1.
 * Frozen for official v1/v2/v3/real-prose/breadth sessions.
 * Not the current experimental candidate. Do not silently rewrite.
 */
...
export const V2_EXTRACTION_PROMPT_V1_VERSION = "archivist_v2_extraction_prompt@v1" as const;
export const V2_PROMPT_V1_STATUS = "historical_frozen" as const;
export const V2_PROMPT_V1_WIRED_TO_PAID_PATH = false;

export const V2_REQUIRED_PROMPT_KINDS_V1 = V2_OBSERVATION_KINDS;

const FORBIDDEN_EDITORIAL_V1 = [
  "continuity finding",
...
export function buildV2ObservationSystemPromptV1(): string {
  return [
    ...
    ...FORBIDDEN_EDITORIAL_V1.map((item) => `- ${item}`),
...
export function buildV2ObservationUserPromptV1(args: {
  segmentId: string;
  segmentText: string;
}): string {
  return [
