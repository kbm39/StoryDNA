  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <h2 className="font-serif text-xl font-semibold tracking-tight">Archivist Dry Run</h2>
          <p className="text-sm text-black/60 dark:text-white/60">Synthetic fixture preview — not the real candidate review</p>
        </div>
