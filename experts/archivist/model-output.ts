...
export function buildArchivistModelOutputInstructions(): string {
  return [
    ...
    "Changeable facts (hair, rank, location, possession, alive/dead, injury condition, relationship status, age) may both be valid when chronology and transition evidence exist.",
