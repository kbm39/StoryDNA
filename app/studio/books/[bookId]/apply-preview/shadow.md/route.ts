...
export async function GET(
  ...
  const body = generateShadowMarkdownDownload(result.shadow);
  const filename = buildShadowPreviewFilename(result.shadow.manuscript.title, result.shadow.generatedAt, "md");
