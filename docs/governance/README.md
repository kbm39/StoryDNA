...
| [Knowledge Domain Analysis and Specialist Recommendation](./implementation/STORYDNA_KNOWLEDGE_DOMAIN_ANALYSIS_FRAMEWORK.md) | `cap.knowledge_domain_analysis` | Design complete (KDA-0); [PRD](./implementation/STORYDNA_KNOWLEDGE_DOMAIN_ANALYSIS_PRD.md) |
